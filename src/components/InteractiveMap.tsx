    ...
    <section className="py-24 bg-white relative overflow-hidden border-b border-slate-100">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-stretch">
          ...
          <div className="lg:col-span-7 bg-slate-50 border border-slate-200 rounded-3xl overflow-hidden min-h-[350px] md:min-h-[450px] shadow-inner relative">
            <iframe
              src={mapUrl}
          ...
          <div className="lg:col-span-5 bg-white border border-slate-200 p-6 md:p-8 rounded-3xl shadow-sm flex flex-col justify-between space-y-6 text-left">
