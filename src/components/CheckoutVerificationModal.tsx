      ...
      <div className="w-full max-w-3xl bg-white border border-slate-200 rounded-3xl shadow-2xl overflow-hidden text-left flex flex-col max-h-[92vh] my-4 animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="px-6 py-4 bg-slate-900 text-white border-b border-slate-800 flex items-center justify-between shrink-0">
          <div className="flex items-center space-x-3">
            <div className="w-9 h-9 rounded-xl bg-accent text-white flex items-center justify-center shadow-md shadow-accent/25">
          ...
          <button
            onClick={onClose}
            className="w-8 h-8 rounded-full bg-slate-800 hover:bg-slate-700 text-slate-400 hover:text-white flex items-center justify-center transition-colors cursor-pointer focus:outline-none"
          >
            <X className="w-4 h-4" />
          </button>
        </div>
        ...
        <div className="px-4 sm:px-6 py-3.5 bg-slate-50 border-b border-slate-200 shrink-0">
          <div className="grid grid-cols-4 gap-2 sm:gap-4">
            {stepsConfig.map((s) => {
              ...
              return (
                <div 
                  key={s.id}
                  className={`flex flex-col sm:flex-row items-center sm:space-x-2.5 p-1.5 sm:p-2 rounded-xl transition-all ${
                    isActive 
                ...
                >
                  <div className={`w-6 h-6 sm:w-7 sm:h-7 rounded-full flex items-center justify-center text-[10px] sm:text-xs shrink-0 ${
                    isCompleted 
                  ...
                  <div className="text-center sm:text-left mt-1 sm:mt-0 leading-tight truncate">
                    <span className="text-[9px] uppercase tracking-wider block opacity-70">Langkah {s.id}</span>
                    <span className="text-[11px] sm:text-xs truncate block">{s.label}</span>
                  </div>
                </div>
              );
            })}
        ...
        <div className="px-6 py-4 bg-slate-50 border-t border-slate-200 flex items-center justify-between shrink-0 gap-3">
          {currentStep > 1 ? (
            <button
              type="button"
              onClick={() => setCurrentStep((prev) => (prev - 1) as StepNumber)}
              className="px-4 py-2.5 bg-white hover:bg-slate-100 border border-slate-200 text-slate-700 rounded-xl text-xs font-bold transition-all cursor-pointer flex items-center space-x-1.5 shadow-2xs"
            >
            ...
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2.5 bg-white hover:bg-slate-100 border border-slate-200 text-slate-600 rounded-xl text-xs font-semibold transition-all cursor-pointer shadow-2xs"
            >
              Batal
            </button>
          )}
          ...
          {currentStep === 2 && (
            <button
              ...
              className="px-6 py-2.5 bg-accent hover:bg-accent-hover text-white rounded-xl text-xs font-display font-bold uppercase tracking-wider transition-all cursor-pointer flex items-center space-x-2 shadow-lg shadow-accent/20"
            >
              <span>Lanjut: Berkas KTP & SIM</span>
              <ArrowRight className="w-4 h-4" />
            </button>
          )}
          ...
          {currentStep === 4 && (
            <button
              ...
              className="px-6 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl text-xs font-display font-bold uppercase tracking-wider transition-all cursor-pointer flex items-center space-x-2 shadow-lg shadow-emerald-600/25 animate-pulse"
            >
              <Check className="w-4 h-4" />
              <span>Konfirmasi Reservasi (Selesai)</span>
            </button>
          )}
        </div>
