...
export default function WhatsAppWidget({ whatsappNumber, brandName }: WhatsAppWidgetProps) {
  ...
  return (
    <a
      ...
      className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-40 flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 hover:-translate-y-1 transition-all duration-300 group cursor-pointer focus:outline-none"
    ...
    >
      ...
      {/* Icon */}
      <img src="/whatsapp-icon.png" className="w-12 h-12 sm:w-14 sm:h-14 relative z-10 object-contain drop-shadow-md" alt="WhatsApp CS" />
